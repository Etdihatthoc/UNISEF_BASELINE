...
def get_optimizer(args, net):
    if args.optimizer == 'sgd':
        ...
        return optim.AdamW(net.parameters(), lr=args.base_lr, betas=args.betas, weight_decay=args.weight_decay, eps=1e-5)
    elif args.optimizer == 'lamb':
        return apex.optimizers.FusedLAMB(net.parameters(), lr=args.base_lr, betas=args.betas, weight_decay=args.weight_decay, eps=1e-5)

def get_optimizer_finetune(args, param_list):
    if args.optimizer == 'sgd':
        return optim.SGD(param_list, lr=args.base_lr, momentum=args.momentum, weight_decay=args.weight_decay)
    elif args.optimizer == 'adam':
        return optim.Adam(param_list, lr=args.base_lr, betas=args.betas, weight_decay=args.weight_decay)
    elif args.optimizer == 'adamw':
        return optim.AdamW(param_list, lr=args.base_lr, betas=args.betas, weight_decay=args.weight_decay, eps=1e-5)
    elif args.optimizer == 'lamb':
        return apex.optimizers.FusedLAMB(param_list, lr=args.base_lr, betas=args.betas, weight_decay=args.weight_decay, eps=1e-5)
